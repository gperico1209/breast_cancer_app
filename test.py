...
# ======================================================
    ...
    st.info("""
    In questa versione lo scenario What If usa:
    - encoding ordinale per T Stage, N Stage e Grade;
    - encoding manuale per Estrogen Status e Progesterone Status;
    - range età esteso da 18 a 100 anni.
    """)
